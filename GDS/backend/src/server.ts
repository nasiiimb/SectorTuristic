...
app.get('/', (req: Request, res: Response) => {
  res.json({
    service: 'GDS - Sistema de Distribución Global',
    version: '1.0.0',
    status: 'online',
    description: 'Orquestador unificado de WebService y Channel',
    endpoints: {
      auth: {
...
app.listen(PORT, () => {
  console.log('');
  console.log('═══════════════════════════════════════════════════════');
  console.log('GDS - Sistema de Distribución Global');
  console.log('═══════════════════════════════════════════════════════');
  ...
  console.log('   GET    /api/reservations/:localizador (auth)');
  console.log('');
});
